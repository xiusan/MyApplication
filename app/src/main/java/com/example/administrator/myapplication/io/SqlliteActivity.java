...
public class SqlliteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_slqlite);
        ...
        findViewById(R.id.login_btn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(account.equals("admin") && pwd.equals("123456")){
                    ...
                    Toast.makeText(SqlliteActivity.this,"登录成功",Toast.LENGTH_SHORT).show();
                }else {
                    //2.2验证失败，提示用户
                    Toast.makeText(SqlliteActivity.this,"账号或密码错误",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
